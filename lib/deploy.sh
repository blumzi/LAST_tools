...
#
# The USB external disk's label will be (by convention) "LAST-CONTAINER"
# When attached to the computer, the disk will be mounted on /media/ocs/LAST-CONTAINER
#
